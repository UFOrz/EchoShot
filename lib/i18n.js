...
const EN = {
  ...
  '反 {count}': 'Vision {count}', '图 {count}': 'Image {count}', '正在获取…': 'Fetching…', '获取中…': 'Fetching…', '已获取 {total} 个，新增 {added} 个': 'Fetched {total}; added {added}', '已获取 {total} 个（反推 {vision}，生图 {image}），新增 {added} 个': 'Fetched {total} (vision {vision}, image {image}); added {added}', '再次点击删除': 'Click again to delete',
...
const JA = {
  ...
  , '反 {count}': '解析 {count}', '图 {count}': '画像 {count}', '正在获取…': '取得中…', '获取中…': '取得中…', '已获取 {total} 个，新增 {added} 个': '{total}件取得、{added}件追加', '已获取 {total} 个（反推 {vision}，生图 {image}），新增 {added} 个': '{total}件取得（解析{vision}、画像{image}）、{added}件追加', '再次点击删除': 'もう一度クリックして削除'
...
const KO = {
  ...
  , '反 {count}': '분석 {count}', '图 {count}': '이미지 {count}', '正在获取…': '가져오는 중…', '获取中…': '가져오는 중…', '已获取 {total} 个，新增 {added} 个': '{total}개 가져옴, {added}개 추가', '已获取 {total} 个（反推 {vision}，生图 {image}），新增 {added} 个': '{total}개 가져옴(분석 {vision}, 이미지 {image}), {added}개 추가', '再次点击删除': '다시 클릭하여 삭제'
